...
export const loadBackup = async (setValue: (value: ArrayBuffer | null) => void, setIsReady: (value: boolean) => void) => {
    try {
...
export const useLoadBackup = (setValue: (value: ArrayBuffer | null) => void, setIsReady: (value: boolean) => void) => {
    useEffect(() => {
